const allItem = document.querySelector(".user-post-item");
...
allPosts.reverse().map((item, index) => {
    ...
    <div class="user-post-header">
      <div class="post-info">
        <img src="${item.author[0].photo}" alt="" />
        <div class="user-details">
          <a class="author" href="#">${item.author[0].name}</a>
          <span
            > ${item.timeAgo}
            <svg
              fill="currentColor"
